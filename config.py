...
# Clips
DEFAULT_CLIP_MODE = "e"  # from (e)nd, from (s)tart, (i)nterval
DEFAULT_NUM_THREADS = 4  # used in processing clip creation
DEFAULT_PRIVACY_STATUS = "unlisted"  # unlisted, public, private
...
COMPRESS_FPS = 30
COMPRESS_RES_HEIGHT = 720  # maintains aspect ratio
